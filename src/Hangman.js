...
const Hangman = ({ guessesLeft }) => {
   ...
   useEffect(()=>{
     levels.current.map(el=>{
      if (el && guessesLeft < el.dataset.level) {
         // el.style = style.show
      } else if (el) {
         // el.style = style.hide
      }
      // console.log(el.style, style.show)
   })
   },[guessesLeft])

   // console.log('levels',levels.current)
   ...
   \}'}
      ...
      <g
         ...
         <path
            ...
            // style={{opacity:1,fill:'none',stroke:'#170055',strokeWidth:1.32292,strokeLinecap:'round',strokeLinejoin:'round',strokeMiterlimit:4,strokeDasharray:'none',strokeOpacity:1}}
         ...
         >
            <path
               // style="fill:none;stroke:#170055;stroke-width:2.18864;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
         ...
         <g
            ...
            <path
               ...
               />
            {/* <path
               // style="fill:#ffffff;stroke:none;stroke-width:2.18864;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1;paint-order:fill markers stroke"
               d="M 102.91951,465.48257 C 33.399756,437.68655 -14.360286,421.36145 -139.55183,417.37408 l -0.4239,48.37578 z"
               id="path895"
               /> */}
         </g>
         <path
